<h1 class="text-4xl text-center m-12">Ajouter un road trip</h1>
<form action="" method="POST" class="w-full place-items-center" enctype="multipart/form-data">
    ...
    <div class="md:flex md:items-center md:mb-6 justify-center max-[600px]:m-6">
        ...
        <div class="md:w-2/3">
            <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" type="file" id="file" name="file" accept="image/png, image/jpeg">
        </div>
    </div>
    <div class="md:flex md:items-center md:mb-6 justify-center max-[600px]:m-6">
        <div class="md:w-1/6">
