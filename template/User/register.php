<div class="relative w-full">
    ...
    <div class="absolute top-0 left-0 w-full h-full flex items-center justify-center">
        <h1 class="text-black text-4xl font-bold">Inscription</h1>
    </div>
</div>
<div>
<div class="flex w-full mt-5 mb-10 items-center flex-col" >
    <form action="" method="POST" class="w-full max-w-sm card p-10 bg-base-100 shadow-xl bg-[#FEEFDD]">
        <div class="md:flex md:flex-col mb-6">
            ...
            <input class="appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" type="email" id="email" name="email" placeholder="exemple@exemple.com" required>
        </div>
        <div class="md:flex md:flex-col mb-6">
            <label class="block text-gray-500 font-bold md:text-left mb-1 md:mb-0 pr-4" for="password">Mot de passe</label>
        ...
        <div class="md:flex md:flex-col mb-6">
            <label class="block text-gray-500 font-bold md:text-left mb-1 md:mb-0 pr-4" for="passwordVerif">Confirmation du mot de passe</label>
            <input class="appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" type="password" id="passwordVerif" name="passwordVerif" minlength="8" required>
        </div>
